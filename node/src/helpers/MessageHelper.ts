...
export default abstract class MessageHelper {
     ...
     */
    public static async reply(client: OlvidClient, message: Message,  body: string, options?: {attachments?: {filename: string, payload: Uint8Array}[], quote?: boolean, disableLinkPreview?: boolean, ephemerality?: MessageEphemerality}) : Promise<Message> {
