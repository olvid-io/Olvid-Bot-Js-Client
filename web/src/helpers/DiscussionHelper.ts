...
export default abstract class DiscussionHelper {
     ...
     */
    public static async postMessage(client: OlvidClient, discussion: Discussion, body: string, options?: {disableLinkPreview?: boolean, ephemerality?: MessageEphemerality}): Promise<Message> {
